    ...
    try {
        ...
        try {
            ...
            if (existingFCMWorker) {
                console.log("기존 Firebase 메시징 서비스 워커를 사용합니다:", existingFCMWorker.scope)
        ...
        const currentToken = await getToken(messaging, {
            vapidKey: "BJU5QrpqOX0cekAcEVGx8NKmAobnUKzEfRqQGKgNvSG61sdBht3KkQPCcB2wDfbkT5NvrYIE5ktp6wBsZOrrPTw",
...
export async function saveFCMToken(userId: number | string, token: string) {
    ...
    try {
        ...
        const response = await fetch(`${apiUrl}/api/notifications/fcm-token?memberId=${userId}`, {
            method: "PATCH",
            headers: {
