...
export default function myPosts(){
    const mockData: CardItemProps[] = Array.from({length:23}, (_, i) => ({
        ...
        button: <RoundedBtn text='게시글 수정하기' width="w-[350px]" bgColor="bg-main" height="h-[30px]" textColor="text-white" hoverBorderColor="hover:border-accent" hoverColor="hover:bg-white" hoverTextColor="hover:text-main"/>,
