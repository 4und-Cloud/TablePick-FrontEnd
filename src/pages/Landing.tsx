        ...
        <div className="flex flex-col px-4 py-3 flex-grow justify-between">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2">
              ...
              {item.categoryName && (
                  <span className="text-sm bg-main text-white px-2 py-0.5 rounded-full">{item.categoryName}</span>
              )}
            </div>

            {/* 주소 */}
            <div className="flex items-start text-medium text-gray-600 mt-1 gap-1">
              <img src={loc || "/placeholder.svg"} alt="location icon" className="w-4 h-4 mr-1" />
      ...
      >
        ...
        <div className="flex flex-col px-4 py-3 flex-grow justify-between">
          ...
          <div className="flex flex-col gap-1">
            ...
            {/* 내용 */}
            <div className="flex items-start text-medium text-gray-600 mt-1 gap-1">
              <img src={content || "/placeholder.svg"} alt="location icon" className="w-4 h-4 mr-1" />
...
//
// const dummy : PostItem[] = [
//   {id: 1, name: '도쿄시장', content: '연어맛집', categoryName: '이자카야', restaurantTags: ['가성비', '서민적인'], imageUrl:"https://lh3.googleusercontent.com/gps-cs-s/AC9h4nqmuhN9M4zJ0xd1RV3SFornU57tQeew43EU3OQbcyso3gAzC3udD41aAPfYawJBiF6O11_NK-3TGkSIMjPzFNXgGGHh8ioG7CxJBrOYciRPYE9ApVdSw2FCYj1lDdP-ZjjTgePF3g=w408-h306-k-no"},
//   {id: 2, name: '도쿄시장', content: '연어맛집 진짜 최고 맛집', categoryName: '이자카야', restaurantTags: ['가성비', '서민적인'], imageUrl:"https://lh3.googleusercontent.com/gps-cs-s/AC9h4nqmuhN9M4zJ0xd1RV3SFornU57tQeew43EU3OQbcyso3gAzC3udD41aAPfYawJBiF6O11_NK-3TGkSIMjPzFNXgGGHh8ioG7CxJBrOYciRPYE9ApVdSw2FCYj1lDdP-ZjjTgePF3g=w408-h306-k-no"},
//   {id: 3, name: '도쿄시장', content: '연어맛집', categoryName: '이자카야', restaurantTags: ['가성비', '서민적인'], imageUrl:"https://lh3.googleusercontent.com/gps-cs-s/AC9h4nqmuhN9M4zJ0xd1RV3SFornU57tQeew43EU3OQbcyso3gAzC3udD41aAPfYawJBiF6O11_NK-3TGkSIMjPzFNXgGGHh8ioG7CxJBrOYciRPYE9ApVdSw2FCYj1lDdP-ZjjTgePF3g=w408-h306-k-no"},
//   {id: 4, name: '도쿄시장', content: '연어맛집', categoryName: '이자카야', restaurantTags: ['가성비', '서민적인'], imageUrl:"https://lh3.googleusercontent.com/gps-cs-s/AC9h4nqmuhN9M4zJ0xd1RV3SFornU57tQeew43EU3OQbcyso3gAzC3udD41aAPfYawJBiF6O11_NK-3TGkSIMjPzFNXgGGHh8ioG7CxJBrOYciRPYE9ApVdSw2FCYj1lDdP-ZjjTgePF3g=w408-h306-k-no"},
// ]
//
// // 레스토랑 카드 컴포넌트
// function RestaurantCard({
...
//           {/* 주소 */}
//           <div className="flex items-start text-medium text-gray-600 mt-1 gap-1">
//             <img src={loc} alt="location icon" className="w-4 h-4 mr-1" />
//             <span className="line-clamp-2">{item.address}</span>
//           </div>
//         </div>
//
...
//           {/* 내용 */}
//           <div className="flex items-start text-medium text-gray-600 mt-1 gap-1">
//             <img src={content} alt="location icon" className="w-4 h-4 mr-1" />
//             <span className="line-clamp-2">{item.content}</span>
//           </div>
//         </div>
//
