...
export default function Pagination( { currentPage, totalPages, onPrevPage, onNextPage, onPageChange, onFirstPage, onLastPage }: paginationProps ) {
    // 페이지 계산 함수
    ...
    return (
        <div className="flex items-center justify-center gap-2 mt-4">
          ...
          <button className="bg-main text-white rounded-md px-3 py-1 disabled:opacity-40" onClick={onLastPage}>&gt;&gt;</button>
        </div>
      );
    }